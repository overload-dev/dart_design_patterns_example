...
import 'package:dart_design_patterns_example/pages/visitor_pattern/components/files_dialog.dart';
import 'package:dart_design_patterns_example/pages/visitor_pattern/components/files_visitor_selection.dart';
import 'package:dart_design_patterns_example/pages/visitor_pattern/files/index.dart';
import 'package:dart_design_patterns_example/pages/visitor_pattern/visitors/human_readable_visitor.dart';
import 'package:dart_design_patterns_example/pages/visitor_pattern/visitors/ivisitor.dart';
import 'package:dart_design_patterns_example/pages/visitor_pattern/visitors/xml_visitor.dart';
import 'package:flutter/material.dart';

class VisitorPatternScreen extends StatefulWidget {
  static String routeName = '/visitor_pattern_screen';

  const VisitorPatternScreen({Key? key}) : super(key: key);

  @override
  _VisitorPatternScreenState createState() => _VisitorPatternScreenState();
}

class _VisitorPatternScreenState extends State<VisitorPatternScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const PreferredSize(
        ...
        child: ProjectAppBar(title: 'Visitor Pattern Example'),
      ),
