...
import 'package:dart_design_patterns_example/pages/composite_pattern/components/audio_file.dart';
import 'package:dart_design_patterns_example/pages/composite_pattern/components/directory.dart';
import 'package:dart_design_patterns_example/pages/composite_pattern/components/image_file.dart';
import 'package:dart_design_patterns_example/pages/composite_pattern/components/text_file.dart';
import 'package:dart_design_patterns_example/pages/composite_pattern/components/video_file.dart';
import 'package:flutter/material.dart';

class CompositePatternScreen extends StatelessWidget {
  static String routeName = '/composite_pattern_screen';

  const CompositePatternScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const PreferredSize(
        ...
        child: ProjectAppBar(title: 'Composite Pattern Example'),
      ),
